...
class SmsResponse(BaseModel):
    ...
    subresource_uris = Column(
        JSON,
        comment="A list of related resources identified by their URIs relative to "
    ...
    error_message = Column(
        String, nullable=True, comment="Description of error code if available"
    )
    status = Column(
    ...
    def __repr__(self):
        return (
            f"SmsResponse(id={self.identifier}, created_on={self.created_at}, updated_on={self.updated_at}, "
